...
namespace OpenSooq.Areas.Dashboard.Controllers
{
    ...
    public class UserProductsController : Controller
    {
        ...
        public UserProductsController(AppDbContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        // GET: Dashboard/UserProducts
        public async Task<IActionResult> Index()
        {
            var appDbContext = _context.Products.Include(p => p.Category).Include(p => p.User).Where(p=>p.UserId == HttpContext.Session.GetInt32("UserId"));
            return View(await appDbContext.ToListAsync());
        }

        // GET: Dashboard/UserProducts/Details/5
        ...
        // GET: Dashboard/UserProducts/Create
        ...
        public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductDesc,ImageFile,ProductImg,Price,CategoryId,UserId,CreationDate,IsDeleted,IsActive")] Product product)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Users.Where(p => p.UserId == HttpContext.Session.GetInt32("UserId")), "UserId", "UserName", product.UserId);
            return View(product);
        }

        // GET: Dashboard/UserProducts/Edit/5
        ...
        // GET: Dashboard/UserProducts/Delete/5
        ...
        // POST: Dashboard/UserProducts/Delete/5
